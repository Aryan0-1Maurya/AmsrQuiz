        ...
        <div id="terms" onClick={handleOutsideClick}>
            <div id="content">
                ...
                <>
                    <h3>Introduction</h3>
                    <p>
                        AmsR Quiz is an interactive web application designed to help users practice and test their knowledge 
                        ...
                        process. AmsR quiz takes your name to only save your quiz progress and show you the results related only to you.
                    </p>
                    ...
                    <ol>
                        ...
                        <li>
                            <strong>User Friendly:</strong> AmsR quiz saves all of your names for you, so whenever you need to sign 
                    ...
                    <h4>Support</h4>
                    <p>For any inquiries or support requests, please reach out to me through <a rel="noreferrer" href="mailto:aauryagk12@gmail.com" target={'_blank'}>Email</a>.</p>
